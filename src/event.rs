...
pub enum WindowEvent {
    ...
    ///
    /// This event is sent when the compositor's voice mode protocol sends an event
    /// to this window. The window must have been registered as a voice mode receiver.
    ///
    /// ## Platform-specific
    ///
